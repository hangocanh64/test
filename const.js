...
const STATUS_QEEG_FIRST_VISIT = 0020;
const STATUS_QEEG_PAID_FREE = 0021;
const STATUS_QEEG_ONLINE = 0022;
const STATUS_PSYCHIATRY = 0023;
const STATUS_TMS = 0024;
const STATUS_TMS_FIRST_VISIT = 0025;
const STATUS_CONSULTATION = 0026;
const STATUS_DUMMY_CARD = 0027;
