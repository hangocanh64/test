...
const STATUS_QEEG_FIRST_VISIT = 210;
const STATUS_QEEG_PAID_FREE = 211;
const STATUS_QEEG_ONLINE = 212;
const STATUS_PSYCHIATRY = 213;
const STATUS_TMS = 214;
const STATUS_TMS_FIRST_VISIT = 215;
const STATUS_CONSULTATION = 216;
const STATUS_DUMMY_CARD = 217;
